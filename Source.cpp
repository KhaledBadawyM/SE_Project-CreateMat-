...
//	
//	CreatMat(string s, vector<CreatMat>input)
//	{
//		data = input;
...
//		return name;
//	}
//private:	void separat_pracket(string S)
//	{
...
//	}
//
//private:	void subMatrix(string subS)
//	{
...
//}
//private: void match(vector<vector<string>> a, int flag)
//	{
...
//				}
//			}
//		//	semicolone_colon_queue.pop();  // to delete first element in the queue which i used
//		}
//
//		else if (a.size() == 0)
//		{
//			//semicolone_colon_queue.pop_back();
//		}
//
//		else if (semicolone_colon_queue.front() == ',') // so its a side concatenate 
//		{
//			//if(a.size()==finalMatrix.size() )// two matrrix have same number of rows so we could sum	
//			//{
//			int n = finalMatrix.size() - a.size();
//			for (int i = 0 ; i < a.size(); i++)
//			{
//				
//				// we don't need to push another rows  
//				for (int j = 0; j < a[i].size(); j++)
//				{
//					/////////////to detect if we have a matrix inside this matrix//////// 
//					int localflag = 0;
...
//			
//			//else
//			//;//print error unmatched matrix 
//		}
//		else if (semicolone_colon_queue.front() == ';')
//		{
//			//if (a[0].size() == finalMatrix[0].size())   // a[0] its a array of pointer and finalmat array of string  
//			//{
//				for (int i = 0; i< a.size(); i++)
//				{
//					vector<string>v;
